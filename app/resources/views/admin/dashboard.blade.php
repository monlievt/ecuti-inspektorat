        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-indigo-900 to-slate-900 rounded-2xl p-6 text-white shadow-sm space-y-4">
                ...
                <div class="pt-2 flex gap-2">
                    ...
                    <a href="{{ Route::has('admin.setting.index') ? route('admin.setting.index') : url('/admin/setting') }}" class="inline-flex items-center justify-center rounded-xl bg-white/10 hover:bg-white/20 text-white px-3.5 py-2.5 text-xs font-semibold border border-white/20 shadow-sm transition gap-1.5">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
