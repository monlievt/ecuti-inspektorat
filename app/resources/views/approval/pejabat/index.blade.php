...
<div class="space-y-6">
    <div class="md:flex md:items-center md:justify-between">
        <div class="min-w-0 flex-1">
            ...
            <p class="mt-1 text-sm text-slate-500">Daftar permohonan cuti pegawai yang berada di bawah wewenang delegasi SK Anda.</p>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden" x-data="{ selectedId: null, actionType: '', actionNotes: '' }">
        @if($pengajuanMenunggu->isEmpty())
            <div class="text-center py-16">
                ...
                <p class="mt-1 text-sm text-slate-500">Tidak ada pengajuan cuti yang menunggu keputusan PyBMC Anda saat ini.</p>
            </div>
        @else
