        ...
        <form action="{{ route('pengajuan.update', $pengajuan) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-600 flex items-start gap-2">
                    ...
                    <span>Untuk cuti <strong>1 hari kerja</strong>, pilih tanggal yang <strong>sama</strong> pada Tanggal Mulai dan Tanggal Selesai.</span>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t border-slate-200">
                ...
                <button type="submit"
                        class="inline-flex items-center justify-center rounded-xl bg-amber-500 px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-amber-400 transition order-1 sm:order-2">
